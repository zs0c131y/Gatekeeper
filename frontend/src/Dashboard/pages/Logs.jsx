        ...
        es.onmessage = (event) => {
            try {
                ...
                setStreamLogs((prev) => {
                    ...
                    if (prev.some((l) => (l.trace_id || l.traceId) === trace)) return prev;
        ...
        <div className="space-y-6">
            ...
            <div className="bg-[#111111] border border-white/10 rounded-xl p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    <Select value={filters.method || "__ALL__"} onValueChange={(v) => handleFilterChange('method', v === "__ALL__" ? "" : v)}>
                    ...
                    <Select value={filters.status || "__ALL__"} onValueChange={(v) => handleFilterChange('status', v === "__ALL__" ? "" : v)}>
                        <SelectTrigger className="bg-white/5 border-white/10 text-white focus:ring-amber-500/50 focus:ring-offset-0">
                            ...
                            <tbody>
                                {logs.map((log, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-gray-300 font-mono text-xs">{log.client_ip || log.clientIp}</td>
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2">
