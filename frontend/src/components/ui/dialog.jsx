  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-md p-1 text-gray-400 opacity-70 ring-offset-transparent transition-all hover:opacity-100 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-amber-500/50 disabled:pointer-events-none data-[state=open]:bg-white/10">
        <X className="h-4 w-4" />
